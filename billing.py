...
def loginWindow():
    titleLabel = Label(window,text="Shree Pharmacy Billing System",font="Arial 40",fg="blue")
    titleLabel.grid(row=0,column=0,columnspan=4, padx=(70,0),pady=(10,0))

    loginLabel = Label(window,text="Admin Login",font="Arial 30")
    loginLabel.grid(row=1, column=1,padx=(50,0),columnspan=5, pady=10)
...
def mainwindow():
    ...
    titleLabel = Label(window,text="Shree Pharmacy Billing System",font="Arial 30",fg="blue")
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="Shree Pharmacy Billing System", width=40,font="Arial 30",fg="green")
